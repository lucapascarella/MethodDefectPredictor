...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--start', type=str, help='Start commit', default=None)  # '49dbdb7f535106aa96e952222fd42ea6b91074fb'  # Excluded
    parser.add_argument('-p', '--stop', type=str, help='Stop commit', default=None)  # '5192e340815e9aad5a59b350b9772319e4518417'  # Excluded
    parser.add_argument('-e', '--ext', type=str, help='List of allowed extensions. Eg. .cpp .c', default='.cpp')
    parser.add_argument('-b', '--bic', type=str, help='Bug inducing commit', default=None)
    parser.add_argument('-o', '--output', type=str, help='Path of the CSV file where save results', default='output.csv')
